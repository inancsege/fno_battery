...
class BasePreprocessor(ABC):
    ...
    This class defines the interface that all dataset-specific preprocessors must implement,
    ensuring consistent data loading, preprocessing, and sequence creation across different
    battery datasets.
    """
    
    def __init__(self, **kwargs):
        """
        Initialize the preprocessor with common parameters.
        
        Parameters:
        -----------
        **kwargs : dict
            Additional keyword arguments specific to the dataset
        """
        self.logger = logging.getLogger("fno_battery")
        self.seq_len = kwargs.get('seq_len', 40)
        self.batch_size = kwargs.get('batch_size', 32)
        self.stride = kwargs.get('stride', None)  # Default is determined later
        
        if self.stride is None:
            # Default: 50% overlap between sequences
            self.stride = max(1, self.seq_len // 2)
            
        self.input_features = kwargs.get('features', [])
        self.target_feature = kwargs.get('target', None)
        self.data_paths = kwargs.get('files', [])
        self.data_dir = kwargs.get('dir', None)
        
        # Record all kwargs for later use
        self.kwargs = kwargs
    ...
    def load_data(self):
        ...
        data : pandas.DataFrame or dict
            The loaded data in the format required by the specific dataset
        """
        pass
    ...
    def preprocess(self, data):
        ...
        -----------
        data : pandas.DataFrame or dict
            The loaded data from the load_data method
            
        Returns:
        --------
        preprocessed_data : pandas.DataFrame or dict
            The preprocessed data ready for sequence creation
        """
        pass
    ...
    def create_sequences(self, preprocessed_data):
        ...
        -----------
        preprocessed_data : pandas.DataFrame or dict
            The preprocessed data from the preprocess method
    ...
    def get_dataset_info(self):
        ...
        --------
        dataset_info : dict
            Information about the dataset, e.g., input_dim, output_dim, etc.
        """
        pass
